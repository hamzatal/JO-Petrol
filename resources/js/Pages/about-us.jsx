                ...
                <div className="container mx-auto px-6 py-6 flex flex-col items-center justify-center">
                    <div className="text-center max-w-4xl mb-16">
                        ...
                        <p className="text-xl mb-8 leading-relaxed">
                            At JO Petrol, we believe movies are more than just entertainment—they're an experience.
                        ...
                        <p className="text-xl mb-8 leading-relaxed">
                            Founded with a passion for storytelling, JO Petrol is committed to delivering high-quality
                        ...
                        <p className="text-xl mb-8 leading-relaxed">
                            Join us as we bring the silver screen closer to you—because at JO Petrol, the magic of movies never stops.
                        </p>
                    </div>
                    ...
                    <div className="w-full max-w-6xl mb-16">
                        ...
                        <p className="text-gray-400 text-center mb-12 text-xl">The talent behind JO Petrol's innovation</p>
